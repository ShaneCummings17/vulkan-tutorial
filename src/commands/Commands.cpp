...
void Commands::recordCommandBuffer(size_t commandBufferIndex, uint32_t imageIndex, const vk::raii::Pipeline& graphicsPipeline) {
    // Variables for later
    ...
    commandBuffer.endRendering2EXT();
...
void Commands::transitionImageLayout(
    uint32_t imageIndex,                                                // The index of the image layout to modify
    ...
    vk::ImageMemoryBarrier2 barrier = {
        ...
        .image = swapchain.getSwapchainImages()[imageIndex],            // Get the exact vk::Image being modified
